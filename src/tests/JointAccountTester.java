...
public class JointAccountTester {
	...
	public static void main(String[] args) {
		...
		JointAccount jaTwo = new JointAccount(new Name("Mrs", "Peggy", "Brown"),
				"MainStreet", new Date(22, 8, 1978), 6740.80, 4477,
				new Name("Mr", "Joe", "Brown"));
		...
		jaOne.setAccountHolder(nameOfAccountHolder);
		jaOne.setAccountHolderTwo(nameofSecondAccountHolder);
		jaOne.setDateOpened(accountOpened);
